...
async def get_analytics_by_pipeline(subdomain: str, session: AsyncSession):
    ...
    leads_andrey = await get_leads_by_filter_async(subdomain, session, responsible_user_id=5837446, pipeline_id=8319714,
                                             status=67829730)
    leads_dmitry = await get_leads_by_filter_async(subdomain, session, responsible_user_id=9606738, pipeline_id=8319714,
                                             status=67829730)
    leads_in_pipeline = await get_leads_by_filter_async(subdomain, session, pipeline_id=8319714, status=67829730)
...
async def get_leads_by_filter_async(subdomain: str, headers: dict, pipeline_id: int, status_id: int = None,
...
async def set_responsible_user_in_lead(lead_ids: list, responsible_user_id: int, subdomain: str, headers: dict):
...
async def set_responsible_user_in_task_by_lead(lead_ids: list, responsible_user_id: int, subdomain: str, headers: dict):
