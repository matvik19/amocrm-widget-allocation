...
from src.amo_widget.token_init import initialize_token_manager, get_new_tokens
...
async def add_user(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail={"status": "Error", "message": str(e), "data": None}
        )
